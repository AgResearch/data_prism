...
###################################################################################
data_folder="m:/Documents/projects/tangential/tgdata/kmers_acremonium"     
output_folder="m:/Documents/projects/tangential/tgdata/kmers_acremonium"   
...
draw_comparison_plot <- function(datalist, output_folder, comparison_plot_image_file, comparison_columns_patterns) {
   ...
   if (length(comparison_columns) < 30 ) {
      ...
      title("Co-spectra of Fungal sequencing data")
      text(2,11,"Lecanicillium and Acremonium")
      text(4,10,"Contaminant")
      text(8,10,"Epichloe")
